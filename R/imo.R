...
#' @examples
#' \dontrun{
#' tuneR_config = system.file("GLPMtuneR_config.toml", package = "imo")
...
# run_PIMo ----------------------------------------------------------------
#' Runs planar ion mirror (PIM) optimization.
#'
#' \code{run_PIMo} runs gridless planar mirror optimization.
#'
...
#' @examples
#' \dontrun{
#' imo_config = system.file("PIMimo_config.toml", package = "imo")
#' run_PIMo(imo_config)
#' }
#' 
#' @export
run_PIMo = function(imo_config, resume = FALSE) {
